...
export function getProxyObject(host: string, port: BigInteger, login: string, password: string) {
    return {
        ipaddress: host,
        port: port,
        type: 5,
...
export function requestListener(getProxyInfo, request, response) {
...
export function connectListener(getProxyInfo, request, socketRequest, head) {
...
export default new ProxyServer(options);
